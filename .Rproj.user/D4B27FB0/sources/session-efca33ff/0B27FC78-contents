...
# 计算暴露分布 Pi（6个等级）
bins <- c(0, 25, 50, 100, 150, 200, Inf) # SSB摄入量分级(g/day)
...
# 可使用如下代码查验模拟所得的全球人口中不同暴露等级对应的百分比
# global_exposure_distribution <- pi_draws %>%
#   summarise(across(starts_with("level_"), ~mean(.x) * 100))
# print(global_exposure_distribution)
# 查验结果：
# # A tibble: 1 × 6
# level_1 level_2 level_3 level_4 level_5 level_6
# <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>
#   1    20.5    16.7    21.5    13.8    9.81    17.6
# 根据观察，该结果大致与185个国家SSBs摄入数据集中体现的全球人口SSBs摄入量分布情况相似
